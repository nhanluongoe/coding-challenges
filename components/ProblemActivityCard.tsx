...
export default function ProblemActivityCard({
  ...
  return (
    <Link
      className="block min-w-0 rounded-lg border border-(--color-border-default) bg-white px-4 py-3 transition hover:-translate-y-px hover:border-(--color-primary-500) hover:bg-(--color-background-surface-alt) focus-visible:outline-3 focus-visible:outline-offset-3 focus-visible:outline-(--color-primary-100)"
    ...
    >
      ...
      <span className="mt-1 block break-words font-black leading-tight">
        {problem.title}
      </span>
