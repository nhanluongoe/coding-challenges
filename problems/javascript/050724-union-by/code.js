...
describe('unionBy', () => {
  ...
  test('primitive values with identity iteratee', () => {
    const arr1 = [1, 2, 3];
    const arr2 = [3, 4, 5];
    expect(unionBy((value) => value, arr1, arr2)).toEqual([1, 2, 3, 4, 5]);
  });

  test('null and undefined values in arrays', () => {
    const arr1 = [null, undefined, 1];
    const arr2 = [1, null, 2];
    expect(unionBy((value) => value, arr1, arr2)).toEqual([
      null,
      undefined,
      1,
      2,
  ...
  test('complex objects with custom function iteratee', () => {
    ...
    const iteratee = (obj) => obj.id + obj.value;
  ...
  test('handling of arrays with different lengths', () => {
    const arr1 = [1, 2];
    const arr2 = [3, 4, 5, 6];
    expect(unionBy((value) => value, arr1, arr2)).toEqual([1, 2, 3, 4, 5, 6]);
  });
